...
import './FeaturedContentAntd.css';

const { Title, Text, Paragraph } = Typography;
const { TabPane } = Tabs;

const FeaturedContentAntd = ({ movies = [] }) => {
          ...
          >
            <Row gutter={[16, 16]}>
              {upcomingMovies.map((movie, index) => (
                <Col xs={24} sm={12} lg={6} key={movie.id}>
                  <Badge.Ribbon
                    text={`${formatTimeUntilRelease(movie.releaseDate)} nữa`}
                    color="volcano"
                  >
                    <Card
                      hoverable
                    ...
                    >
                      ...
                      <Space direction="vertical" size={8} style={{ width: '100%' }}>
                        ...
                        <Space>
                          <Users size={14} />
                          <Text type="secondary">
                            {formatNumber(movie.preorders)} đặt trước
                          </Text>
                        </Space>
                        <div>
                          <Text type="secondary">Mức độ mong chờ</Text>
                          <Progress
                            percent={movie.anticipation}
                            size="small"
                            strokeColor="#ff6b35"
                          />
                        </div>
...
export default FeaturedContentAntd;
